<section class="bg-white shadow">
  <div class="container mx-auto flex justify-between items-center">
    <div class="flex items-center">
      <img src="/images/logo.jpg" alt="logo" class="w-16 h-16">
      <h1 class="text-2xl font-bold text-gray-800">Cooking Laravel now</h1>
      <img src="/images/logo02.jpg" alt="logo" class="w-16 h-16">
    </div>
    <form>
